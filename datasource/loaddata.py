...
def generic_file_source_options_example(spark):
    ...
    test_corrupt_df = spark.read.parquet(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\dir1/",
                                         r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\dir1/dir2/")
    ...
    recursive_loaded_df = spark.read.format("parquet")\
        ...
        .load(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\dir1")
    ...
    df = spark.read.load(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\dir1",
...
def basic_datasource_example(spark):
    ...
    df = spark.read.load(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\users.parquet")
    ...
    df = spark.read.parquet(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\users.parquet")
    (df
        .write
    ...
    df = spark.read.load(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\people.json", format="json")
    df.select("name", "age").write.save("namesAndAges.parquet", format="parquet")
    # $example off:manual_load_options$

    # $example on:manual_load_options_csv$
    df = spark.read.load(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\people.csv",
                         format="csv", sep=";", inferSchema="true", header="true")
    # $example off:manual_load_options_csv$

    # $example on:manual_save_options_orc$
    df = spark.read.orc(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\users.orc")
    (df.write.format("orc")
    ...
    df = spark.sql("SELECT * FROM parquet.`D:\\spark-3.1.1-bin-hadoop2.7\\examples\\src\\main\\resources\\users.parquet`")
...
def parquet_example(spark):
    ...
    peopleDF = spark.read.json(r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\people.json")
...
def json_dataset_example(spark):
    ...
    path = r"D:\spark-3.1.1-bin-hadoop2.7\examples\src\main\resources\people.json"
